...
function useCarouselController(options) {
  ...
  const onScrollEnd = _react.default.useCallback(() => {
    ...
    (_options$onScrollEnd = options.onScrollEnd) === null || _options$onScrollEnd === void 0 || _options$onScrollEnd.call(options);
  }, [options]);
  const onScrollStart = _react.default.useCallback(() => {
    var _options$onScrollStar;
    (_options$onScrollStar = options.onScrollStart) === null || _options$onScrollStar === void 0 || _options$onScrollStar.call(options);
  }, [options]);
  ...
  const next = _react.default.useCallback((opts = {}) => {
    ...
    onScrollStart === null || onScrollStart === void 0 || onScrollStart();
