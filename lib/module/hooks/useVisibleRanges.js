...
export function useVisibleRanges(options) {
  ...
  const ranges = useDerivedValue(() => {
    var _cachedRanges$current, _cachedRanges$current2;
    ...
    if (isArraysEqual(((_cachedRanges$current = cachedRanges.current) === null || _cachedRanges$current === void 0 ? void 0 : _cachedRanges$current.negativeRange) ?? [], newRanges.negativeRange) && isArraysEqual(((_cachedRanges$current2 = cachedRanges.current) === null || _cachedRanges$current2 === void 0 ? void 0 : _cachedRanges$current2.positiveRange) ?? [], newRanges.positiveRange)) return cachedRanges.current;
